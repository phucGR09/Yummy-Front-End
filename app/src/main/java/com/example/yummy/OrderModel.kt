...
class OrderModel {
    ...
    fun getOrdersList(restaurantId: Int) {
        val serverData = listOf(
            Order(1, restaurantId, 101, 201, LocalDateTime.now().minusHours(3), 50000.0, OrderStatus.waiting_delivery),
            ...
            Order(5, restaurantId, 105, 205, LocalDateTime.now(), 45000.0, OrderStatus.waiting_delivery),
